...
func (c *testApiClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoRequest, error) {
	out := new(EchoRequest)
...
func (UnimplementedTestApiServer) Echo(context.Context, *EchoRequest) (*EchoRequest, error) {
...
func _TestApi_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestApiServer).Echo(ctx, req.(*EchoRequest))
	}
